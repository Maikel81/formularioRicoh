...
package formulario.bussines.service;
...
public class UsuarioLocalServiceWrapper
	...
	public void addNewUsuario(
		...
		_usuarioLocalService.addNewUsuario(
			nombre, apellidos, correo, fecha_nac);
	}
	 ...
	 */
	@Override
	public formulario.bussines.model.Usuario addUsuario(
		formulario.bussines.model.Usuario usuario) {
	 ...
	 */
	@Override
	public formulario.bussines.model.Usuario createUsuario(long usuarioId) {
	 ...
	 */
	@Override
	public formulario.bussines.model.Usuario deleteUsuario(long usuarioId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public formulario.bussines.model.Usuario deleteUsuario(
		formulario.bussines.model.Usuario usuario) {
	...
	@Override
	public formulario.bussines.model.Usuario fetchUsuario(long usuarioId) {
	 ...
	 */
	@Override
	public formulario.bussines.model.Usuario getUsuario(long usuarioId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<formulario.bussines.model.Usuario> getUsuarios(
		int start, int end) {
	 ...
	 */
	@Override
	public formulario.bussines.model.Usuario updateUsuario(
		formulario.bussines.model.Usuario usuario) {
