 ...
 * <code>formulario.bussines.service.impl.UsuarioLocalServiceImpl</code> and
...
public class UsuarioLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>formulario.bussines.service.impl.UsuarioLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static void addNewUsuario(
		String nombre, String apellidos, String correo,
		java.util.Date fecha_nac) {

		getService().addNewUsuario(nombre, apellidos, correo, fecha_nac);
	}
