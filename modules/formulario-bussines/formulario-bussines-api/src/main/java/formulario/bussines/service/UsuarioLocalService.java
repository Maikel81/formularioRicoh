...
public interface UsuarioLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>formulario.bussines.service.impl.UsuarioLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the usuario local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UsuarioLocalServiceUtil} if injection and service tracking are not available.
	 */
	public void addNewUsuario(
		String nombre, String apellidos, String correo, Date fecha_nac);
